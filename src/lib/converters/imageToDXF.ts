...
import { traceContours, contoursToDXF } from '../image-processing/vectorization'
...
export async function convertToDXF(
    ...
    return new Promise((resolve, reject) => {
        ...
        img.onload = () => {
            ...
            // Convert contours to DXF with smoothness control
            const dxf = contoursToDXF(contours, canvas.width, canvas.height, smoothness)
